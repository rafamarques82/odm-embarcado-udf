...
class OdmRealExecutionTest {
    ...
    private static final String FAT_JAR       = "target/embarcado-95-1.0.0.jar";
    ...
    static void setup() throws Exception {
        ...
        // Fallback para testes unitários (sem SparkContext): System Property
        System.setProperty("odm.metrics.initialized", "true");
