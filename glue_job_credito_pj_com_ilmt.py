...
# =============================================================================
# 📊 ILMT INTEGRATION DETAILS
# =============================================================================
# Este script integra automaticamente com IBM License Metric Tool (ILMT)
# para rastreamento de uso de licenças ODM.
#
# FUNCIONAMENTO:
# 1. Após processar todas as decisões, o script chama S3MetricsHelper.sendIlmtMetrics()
# 2. O método Java gera 2 tipos de relatórios XML:
#    a) ILMT Report (formato oficial IBM): usa DecisionMeteringReport.writeILMTFile()
#    b) Custom Report: métricas adicionais de performance
#
# 3. Ambos os arquivos são enviados para S3 com particionamento temporal:
#    s3://{bucket}/{prefix}/yyyy/MM/dd/HH/ilmt-report-{timestamp}.xml
#    s3://{bucket}/{prefix}/yyyy/MM/dd/HH/custom-report-{timestamp}.xml
#
# MÉTRICAS ILMT:
# - MILLION_MONTHLY_DECISIONS: quando >= 1 milhão de decisões
# - THOUSAND_MONTHLY_ARTIFACTS: quando < 1 milhão de decisões
# - Granularidade: 3 casas decimais (ex: 4.999 = 4 milhões, 999 mil decisões)
#
# CONFIGURAÇÃO:
# - S3_ILMT_BUCKET: bucket de destino (padrão: mesmo do output)
# - S3_ILMT_PREFIX: prefixo S3 (padrão: "embarcado/ilmt-reports/")
# - S3_ILMT_REGION: região AWS (padrão: sa-east-1)
#
# REQUISITOS:
# - JAR odm-embarcado-udf-1.0.0.jar deve conter:
#   * br.com.itau.odm.embarcado.S3MetricsHelper
#   * br.com.itau.odm.embarcado.DecisionMetering
#   * br.com.itau.odm.embarcado.DecisionMeteringReport
#   * com.ibm.license.metric.* (ILMT libraries)
# - Permissões IAM: s3:PutObject no bucket de destino
# =============================================================================
"""
